...
public class ReservationCreateFormController implements Initializable {
    ...
    void createReservation(ActionEvent event) {
        ...
        try {
            ...
            Integer status = cmbStatus.getValue().equals(ReservationStatus.CONFIRMED.getName()) ? ReservationStatus.CONFIRMED.getId() : ReservationStatus.PENDING.getId();
            ...
            if (chbCheckIn.isSelected()) {
                id = reservationService.save(reservationDto);
    ...
    void searchCustomer(ActionEvent event) {
        ...
        try {
            ...
            String customerFullName = customerDto.getFirstName() + " " + customerDto.getMiddleName() + " " + customerDto.getLastName();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            cmbStatus.setItems(FXCollections.observableArrayList(ReservationStatus.PENDING.getName(), ReservationStatus.CONFIRMED.getName()));
